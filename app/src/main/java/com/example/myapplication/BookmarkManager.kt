...
object BookmarkManager {
    ...
    private const val PREFS_NAME = "com.example.myapplication.bookmarks"
    ...
    fun getBookmarks(context: Context): MutableList<Bookmark> {
        ...
        if (bookmarks == null || bookmarks.isEmpty()) {
            bookmarks = mutableListOf(
                Bookmark("may", "https://may.2chan.net/b/futaba.php?mode=cat")
            )
    ...
    fun getSelectedBookmarkUrl(context: Context): String {
        ...
        val defaultUrl = existingBookmarks.firstOrNull()?.url ?: "https://may.2chan.net/b/futaba.php?mode=cat"
